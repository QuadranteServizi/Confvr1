    ...
    var gfeedfetcher_loading_image="css/images/ajax-loader.gif" //Full URL to "loading" image. No need to config after this line!!

    google.load("feeds", "1") //Load Google Ajax Feed API (version 1)

    function gfeedfetcher(divid, linktarget){
    ...
    this.itemcontainer="<"+containerstr.toLowerCase()+" class='feed-item'>"
    }

    gfeedfetcher.prototype.init=function(){
        this.feedsfetched=0 //reset number of feeds fetched to 0 (in case init() is called more than once)
        this.feeds=[] //reset feeds[] array to empty (in case init() is called more than once)
        this.feedcontainer.innerHTML='<img src="'+gfeedfetcher_loading_image+'" alt="loading" />'
        var displayer=this;
    ...
    gfeedfetcher.prototype._displayresult=function(feeds){
        ...
        $(this.feedcontainer).before('<p>Showing latest posts.</p>');
    }